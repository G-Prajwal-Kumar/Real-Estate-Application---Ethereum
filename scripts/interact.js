...
const contract = require('D:/Prajwal/Project School/Hello-World/artifacts/contracts/Hello World.sol/HelloWorld.json');
...
async function main() {
    ...
    const tx = await helloWorldContract.update("Good Bye, World! Just Checking In!");
    await tx.wait();
